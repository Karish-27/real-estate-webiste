...
# NestPrime Backend Quick Setup Script
# This script helps you set up the NestPrime backend quickly
...
# Header
print_header "🏠 NestPrime Backend Setup"
print_header "============================"
echo ""
...
MONGO_URI=mongodb://localhost:27017/NestPrime
